...
GeneratorOptions :: struct {
    ...
    enumValueNameRemovePostfixes : []string,
  	...
  	odin_imports: map[string]string,
...
generate :: proc(
    ...
    fmt.fprint(fd=data.handle, args={"package ", packageName, "\n"}, sep="");
    fmt.fprint(data.handle, "\n");
    fmt.fprint(fd=data.handle, args={"foreign import \"", foreignLibrary, "\"\n"}, sep="");
    fmt.fprint(data.handle, "\n");
    fmt.fprint(fd=data.handle, args={"import _c \"core:c\"\n"}, sep="");
    fmt.fprint(data.handle, "\n");
    for name in options.odin_imports {
      fmt.fprintf(data.handle, "import %s \"%s\"\n", name, options.odin_imports[name]);
    }

    for line in options.extra_type_string_lines {
    ...
    fmt.fprint(fd=data.handle, args={"foreign ", foreignLibrarySimple, " {\n"}, sep="");
    fmt.fprint(data.handle, "\n");
